...
var (
	...
	OrmDriverNotSupported          = New("driver %s not registered. Import the driver package and call RegisterDriver() in your init() function. See docs/driver-registration.md for examples")
	...
	SchemaFailedToCreateView   = New("failed to create %s view: %v")
	SchemaFailedToDropView     = New("failed to drop %s view: %v")
	SchemaFailedToDropColumns  = New("failed to drop %s table columns: %v")
	SchemaFailedToGetViews     = New("failed to get %s views: %v")

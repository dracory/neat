...
// RunExample demonstrates the CSVDB driver with embedded CSV files.
// The data directory is embedded into the binary via //go:embed and
// passed to the driver through ConnectionConfig.FS.
func RunExample() error {
	// Create a CSVDB-driver database connection using the embedded filesystem.
	// The "data" path is the root directory inside the embed.FS.

...
func TestTiDBIntegrationQueryIncrement(t *testing.T) {
	if testing.Short() {
...
func TestTiDBIntegrationQueryDecrement(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationQueryIncrementDecrementWithWhere(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

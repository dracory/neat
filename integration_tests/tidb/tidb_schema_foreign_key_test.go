...
func TestTiDBSchemaForeignKeyCreateTable(t *testing.T) {
	if testing.Short() {
...
func TestTiDBSchemaForeignKeyAddToExistingTable(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBSchemaForeignKeyCustomNames(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBSchemaForeignKeyDrop(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

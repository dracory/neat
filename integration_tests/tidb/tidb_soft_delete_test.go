...
// TestTiDBIntegrationSoftDelete tests soft delete behavior
func TestTiDBIntegrationSoftDelete(t *testing.T) {
...
// TestTiDBIntegrationWithTrashed tests WithTrashed method
func TestTiDBIntegrationWithTrashed(t *testing.T) {
...
// TestTiDBIntegrationForceDelete tests ForceDelete method
func TestTiDBIntegrationForceDelete(t *testing.T) {
...
// TestTiDBIntegrationRestore tests Restore method
func TestTiDBIntegrationRestore(t *testing.T) {
...
// TestTiDBIntegrationSoftDeleteWithConditions tests soft delete with where conditions
func TestTiDBIntegrationSoftDeleteWithConditions(t *testing.T) {
...
// TestTiDBIntegrationRestoreWithConditions tests restore with conditions
func TestTiDBIntegrationRestoreWithConditions(t *testing.T) {
...
// TestTiDBIntegrationOnlyTrashed tests OnlyTrashed method
func TestTiDBIntegrationOnlyTrashed(t *testing.T) {
...
// TestTiDBIntegrationWithoutTrashed tests WithoutTrashed method
func TestTiDBIntegrationWithoutTrashed(t *testing.T) {

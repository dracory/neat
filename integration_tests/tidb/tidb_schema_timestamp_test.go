...
func TestTiDBSchemaTimestamps(t *testing.T) {
...
func TestTiDBSchemaTimestampsTz(t *testing.T) {
...
func TestTiDBSchemaSoftDeletes(t *testing.T) {
...
func TestTiDBSchemaDropTimestamps(t *testing.T) {
...
func TestTiDBSchemaDropTimestampsTz(t *testing.T) {
...
func TestTiDBSchemaTimestampPrecision(t *testing.T) {

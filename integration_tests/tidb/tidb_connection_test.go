...
func TestTiDBIntegrationConnectionSwitch(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

	config := GetTiDBConfig()
	config.Connections["tidb2"] = config.Connections["tidb"]
	...
	conn1 := db
	conn2, err := db.Connection("tidb2")
	if err != nil {
		t.Fatalf("Failed to get tidb2 connection: %v", err)
	}
...
func TestTiDBIntegrationConnectionDefaultName(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationConnectionNonExistent(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationReadWriteSeparation(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

	baseConn := GetTiDBConfig().Connections["tidb"]
...
func TestTiDBIntegrationConnectionPoolSettings(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

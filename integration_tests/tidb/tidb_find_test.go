...
func setupFindTest(t *testing.T) queryable {
	return SetupTiDBTest(t)
}

// TestTiDBIntegrationFirst tests First operation
func TestTiDBIntegrationFirst(t *testing.T) {
	if testing.Short() {
...
// TestTiDBIntegrationFind tests Find operation
func TestTiDBIntegrationFind(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestTiDBIntegrationCreate tests Create operation
func TestTiDBIntegrationCreate(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestTiDBIntegrationUpdate tests Update operation
func TestTiDBIntegrationUpdate(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestTiDBIntegrationDelete tests Delete operation
func TestTiDBIntegrationDelete(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

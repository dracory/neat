...
// TestTiDBSchemaColumnChange tests column change operations
func TestTiDBSchemaColumnChange(t *testing.T) {
	if testing.Short() {
...
// TestTiDBSchemaColumnChangeType tests changing column types
func TestTiDBSchemaColumnChangeType(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestTiDBSchemaColumnChangeNullable tests changing nullable status
func TestTiDBSchemaColumnChangeNullable(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

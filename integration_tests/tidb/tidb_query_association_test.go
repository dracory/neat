...
func TestTiDBIntegrationQueryAssociationFind(t *testing.T) {
	if testing.Short() {
...
func TestTiDBIntegrationQueryAssociationAppendHasOne(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationQueryAssociationAppendHasMany(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationQueryAssociationReplaceHasOne(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationQueryAssociationCount(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationQueryAssociationReplaceHasMany(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationQueryAssociationDelete(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationQueryAssociationClear(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationQueryAssociationWithConditions(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationQueryPolymorphicAssociation(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	...
	if _, err := query.Exec("CREATE TABLE IF NOT EXISTS posts (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, title VARCHAR(255), content TEXT, created_at TIMESTAMP, updated_at TIMESTAMP)"); err != nil {
		t.Fatalf("Failed to create posts table: %v", err)
	}
	if _, err := query.Exec("CREATE TABLE IF NOT EXISTS videos (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, title VARCHAR(255), url VARCHAR(255), created_at TIMESTAMP, updated_at TIMESTAMP)"); err != nil {
		t.Fatalf("Failed to create videos table: %v", err)
	}
	if _, err := query.Exec("CREATE TABLE IF NOT EXISTS comments (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, body TEXT, commentable_id INT UNSIGNED, commentable_type VARCHAR(255), created_at TIMESTAMP, updated_at TIMESTAMP)"); err != nil {
...
func TestTiDBIntegrationQueryAssociationBelongsTo(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

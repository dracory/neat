...
func TestTiDBIntegrationQueryBelongsToWith(t *testing.T) {
	if testing.Short() {
...
func TestTiDBIntegrationQueryBelongsToWithout(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationQueryBelongsToWithConstraints(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBIntegrationQueryMultipleBelongsTo(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

...
func TestTiDBSchemaColumnMethodsHasColumn(t *testing.T) {
	if testing.Short() {
...
func TestTiDBSchemaColumnMethodsHasColumns(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBSchemaColumnMethodsDropColumn(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBSchemaColumnMethodsDropColumns(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBSchemaColumnMethodsHasColumnsAfterDrops(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBSchemaColumnMethodsSingleColumn(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBSchemaColumnMethodsEmptyColumnList(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

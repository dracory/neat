...
func TestTiDBSchemaTableCreateHasDrop(t *testing.T) {
...
func TestTiDBSchemaTableRename(t *testing.T) {
...
func TestTiDBSchemaTableGetTables(t *testing.T) {
...
func TestTiDBSchemaTableModify(t *testing.T) {

...
func TestTiDBSchemaIndexCreateHasGetListing(t *testing.T) {
	if testing.Short() {
...
func TestTiDBSchemaIndexMultiColumn(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBSchemaIndexGetIndexesVerification(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBSchemaIndexDrop(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTiDBSchemaIndexRename(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

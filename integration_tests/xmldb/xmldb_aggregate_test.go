...
func TestXMLDBIntegrationCountAll(t *testing.T) {
	db := SetupXMLDBTest(t)

	var result []xmldbCountResult
	err := db.Query().
		Table("users").
		Select("COUNT(*) AS cnt").
		Get(&result)
...
func TestXMLDBIntegrationCountWithWhere(t *testing.T) {
	db := SetupXMLDBTest(t)
...
func TestXMLDBIntegrationSum(t *testing.T) {
	db := SetupXMLDBTest(t)

	var result []xmldbSumResult
	err := db.Query().
		Table("orders").
...
func TestXMLDBIntegrationAvg(t *testing.T) {
	db := SetupXMLDBTest(t)

	var result []xmldbAvgResult
	err := db.Query().
		Table("products").
...
func TestXMLDBIntegrationMinMax(t *testing.T) {
	db := SetupXMLDBTest(t)

	var result []xmldbMinMaxResult
	err := db.Query().
		Table("products").
...
func TestXMLDBIntegrationGroupBy(t *testing.T) {
	db := SetupXMLDBTest(t)
...
func TestXMLDBIntegrationSumWithJoin(t *testing.T) {
	db := SetupXMLDBTest(t)

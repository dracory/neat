...
// TestPostgreSQLIntegrationRawUpdate tests raw SQL expressions in Update
func TestPostgreSQLIntegrationRawUpdate(t *testing.T) {
	if testing.Short() {
...
// TestPostgreSQLIntegrationRawWhere tests raw SQL expressions in Where clauses
func TestPostgreSQLIntegrationRawWhere(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestPostgreSQLIntegrationDatabaseFunctions tests database-specific raw functions
func TestPostgreSQLIntegrationDatabaseFunctions(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	...
	// Update using PostgreSQL-specific function (UPPER)
	// Note: neat may not have a Raw() function, so we'll skip this test
	// or adapt it to use the available API
	t.Skip("Raw expressions not currently supported in neat")
}

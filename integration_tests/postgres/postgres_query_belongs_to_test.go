...
// TestPostgreSQLIntegrationQueryBelongsTo tests BelongsTo relationships
func TestPostgreSQLIntegrationQueryBelongsTo(t *testing.T) {
	if testing.Short() {
	...
	t.Run("belongs to with", func(t *testing.T) {
		user := &models.User{
	...
	t.Run("belongs to without", func(t *testing.T) {
		user := &models.User{
		...
		var userAddress models.Address
		// With("User") but then Without("User")
	...
	t.Run("belongs to with constraints", func(t *testing.T) {
		user := &models.User{
	...
	t.Run("multiple belongs-to relationships", func(t *testing.T) {

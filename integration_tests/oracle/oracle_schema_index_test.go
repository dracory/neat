...
func TestOracleSchemaIndexCreateHasGetListing(t *testing.T) {
	if testing.Short() {
	...
	// Oracle index names are converted to lowercase by the processor
...
func TestOracleSchemaIndexMultiColumn(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleSchemaIndexGetIndexesVerification(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleSchemaIndexDrop(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleSchemaIndexRename(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

...
// TestOracleIntegrationSoftDelete tests soft delete behavior
func TestOracleIntegrationSoftDelete(t *testing.T) {
	if testing.Short() {
...
// TestOracleIntegrationWithTrashed tests WithTrashed method
func TestOracleIntegrationWithTrashed(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationForceDelete tests ForceDelete method
func TestOracleIntegrationForceDelete(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationRestore tests Restore method
func TestOracleIntegrationRestore(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationSoftDeleteWithConditions tests soft delete with where conditions
func TestOracleIntegrationSoftDeleteWithConditions(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationRestoreWithConditions tests restore with conditions
func TestOracleIntegrationRestoreWithConditions(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationOnlyTrashed tests OnlyTrashed method
func TestOracleIntegrationOnlyTrashed(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationWithoutTrashed tests WithoutTrashed method
func TestOracleIntegrationWithoutTrashed(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

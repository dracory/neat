...
func TestOracleIntegrationQueryLoadSingleRelationship(t *testing.T) {
	if testing.Short() {
...
func TestOracleIntegrationQueryLoadWithConstraints(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleIntegrationQueryLoadMissing(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

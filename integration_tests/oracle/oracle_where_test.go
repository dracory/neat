...
// TestOracleIntegrationWhereIn tests WhereIn operation
func TestOracleIntegrationWhereIn(t *testing.T) {
	if testing.Short() {
...
// TestOracleIntegrationOrWhereIn tests OrWhereIn operation
func TestOracleIntegrationOrWhereIn(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationWhereNotIn tests WhereNotIn operation
func TestOracleIntegrationWhereNotIn(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationOrWhereNotIn tests OrWhereNotIn operation
func TestOracleIntegrationOrWhereNotIn(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationWhereBetween tests WhereBetween operation
func TestOracleIntegrationWhereBetween(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationWhereNotBetween tests WhereNotBetween operation
func TestOracleIntegrationWhereNotBetween(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationOrWhereBetween tests OrWhereBetween operation
func TestOracleIntegrationOrWhereBetween(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationOrWhereNotBetween tests OrWhereNotBetween operation
func TestOracleIntegrationOrWhereNotBetween(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationWhereNull tests WhereNull operation
func TestOracleIntegrationWhereNull(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationWhereNotNull tests WhereNotNull operation
func TestOracleIntegrationWhereNotNull(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationOrWhereNull tests OrWhereNull operation
func TestOracleIntegrationOrWhereNull(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationOrWhere tests OrWhere operation
func TestOracleIntegrationOrWhere(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationWhereColumnOperator tests where with column operator variations
func TestOracleIntegrationWhereColumnOperator(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

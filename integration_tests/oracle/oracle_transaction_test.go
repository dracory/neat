...
func TestOracleTransactionCommit(t *testing.T) {
	if testing.Short() {
...
func TestOracleTransactionRollback(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleTransactionErrorHandling(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleNestedTransactions(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleTransactionIsolationLevels(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	...
	// Oracle driver only supports default isolation level
	// Test that we can begin a transaction with default options
	err := db.Transaction(func(tx contractsorm.Query) error {
		innerTx, err := db.Query().Begin()
		if err != nil {
			return err
		}
	...
	if err != nil {
		t.Errorf("Transaction with default isolation level failed: %v", err)
	}
}

...
func TestOracleIntegrationWhereColumn(t *testing.T) {
	if testing.Short() {
...
func TestOracleIntegrationOrWhereColumn(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleIntegrationWhereExists(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleIntegrationWhereNot(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleIntegrationOrWhereNot(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleIntegrationExists(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

...
func setupFindTest(t *testing.T) *database.Database {
	return SetupOracleTest(t)
}

// TestOracleIntegrationFirst tests First operation
func TestOracleIntegrationFirst(t *testing.T) {
	if testing.Short() {
...
// TestOracleIntegrationFind tests Find operation
func TestOracleIntegrationFind(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationCreate tests Create operation
func TestOracleIntegrationCreate(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationUpdate tests Update operation
func TestOracleIntegrationUpdate(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationDelete tests Delete operation
func TestOracleIntegrationDelete(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

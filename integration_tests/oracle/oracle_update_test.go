...
// TestOracleIntegrationUpdateByModel tests updating a model instance
func TestOracleIntegrationUpdateByModel(t *testing.T) {
	if testing.Short() {
...
// TestOracleIntegrationUpdateByTable tests updating records using table method
func TestOracleIntegrationUpdateByTable(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationUpdateWithWhere tests updating with where clause
func TestOracleIntegrationUpdateWithWhere(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationUpdateMultipleColumns tests updating multiple columns
func TestOracleIntegrationUpdateMultipleColumns(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationUpdateOrCreate tests update or create operation
func TestOracleIntegrationUpdateOrCreate(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationSaveUpdate tests save operation for updating existing records
func TestOracleIntegrationSaveUpdate(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestOracleIntegrationSaveQuietly tests save quietly operation
func TestOracleIntegrationSaveQuietly(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

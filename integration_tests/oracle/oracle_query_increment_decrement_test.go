...
func TestOracleIntegrationQueryIncrement(t *testing.T) {
	if testing.Short() {
...
func TestOracleIntegrationQueryDecrement(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestOracleIntegrationQueryIncrementDecrementWithWhere(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

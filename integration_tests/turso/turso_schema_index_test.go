...
func TestTursoSchemaIndexCreateHasGetListing(t *testing.T) {
	if testing.Short() {
...
func TestTursoSchemaIndexMultiColumn(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTursoSchemaIndexGetIndexesVerification(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTursoSchemaIndexDrop(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTursoSchemaIndexRename(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

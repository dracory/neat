...
func TestTursoIntegrationQueryIncrement(t *testing.T) {
	if testing.Short() {
...
func TestTursoIntegrationQueryIncrementByAmount(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTursoIntegrationQueryDecrement(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTursoIntegrationQueryDecrementByAmount(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTursoIntegrationQueryIncrementDecrementInvalidColumn(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

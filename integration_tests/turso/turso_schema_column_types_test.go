...
func TestTursoSchemaColumnTypeUnsignedSmallInteger(t *testing.T) {
	db := SetupTursoTest(t)
...
func TestTursoSchemaColumnTypeTimestampTzUseCurrent(t *testing.T) {
	db := SetupTursoTest(t)
...
func TestTursoSchemaColumnTypeDateTimeUseCurrent(t *testing.T) {
	db := SetupTursoTest(t)
...
func TestTursoSchemaColumnTypeDateTimeTzUseCurrent(t *testing.T) {
	db := SetupTursoTest(t)
...
func TestTursoEnumConstraint(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

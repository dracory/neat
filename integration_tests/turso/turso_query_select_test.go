...
func TestTursoIntegrationQuerySelectSpecificColumns(t *testing.T) {
	if testing.Short() {
...
func TestTursoIntegrationQuerySelectWithAliases(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTursoIntegrationQuerySelectWithRawSubqueries(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestTursoIntegrationQuerySelectWithSubqueryCallbacks(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

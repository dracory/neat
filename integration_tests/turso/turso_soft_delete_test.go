...
// TestTursoIntegrationSoftDelete tests soft delete behavior
func TestTursoIntegrationSoftDelete(t *testing.T) {
	if testing.Short() {
...
// TestTursoIntegrationWithTrashed tests WithTrashed method
func TestTursoIntegrationWithTrashed(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestTursoIntegrationForceDelete tests ForceDelete method
func TestTursoIntegrationForceDelete(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
	...
	res, err = db.Query().Model(&models.User{}).Where("name = ?", "force_delete_user").HardDelete(&models.User{})
	if err != nil {
...
// TestTursoIntegrationRestore tests Restore method
func TestTursoIntegrationRestore(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestTursoIntegrationOnlyTrashed tests OnlyTrashed method
func TestTursoIntegrationOnlyTrashed(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestTursoIntegrationWithoutTrashed tests WithoutTrashed method
func TestTursoIntegrationWithoutTrashed(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

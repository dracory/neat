...
// TestSQLServerSchemaViewCreateRawRoundTrip verifies the full CreateViewRaw → HasView →
// DropViewIfExists → !HasView round-trip on SQL Server.
func TestSQLServerSchemaViewCreateRawRoundTrip(t *testing.T) {
...
// TestSQLServerSchemaViewDropView verifies DropView on an existing view.
func TestSQLServerSchemaViewDropView(t *testing.T) {
	db := SetupSQLServerTest(t)
...
// TestSQLServerSchemaViewCreateWithQuery verifies CreateView with a query builder.
func TestSQLServerSchemaViewCreateWithQuery(t *testing.T) {
	db := SetupSQLServerTest(t)
...
// TestSQLServerSchemaViewCreateRawEmpty verifies that empty select SQL is rejected.
func TestSQLServerSchemaViewCreateRawEmpty(t *testing.T) {
	db := SetupSQLServerTest(t)

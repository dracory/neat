...
func TestSQLServerIntegrationQueryBelongsToWith(t *testing.T) {
	if testing.Short() {
...
func TestSQLServerIntegrationQueryBelongsToWithout(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLServerIntegrationQueryBelongsToWithConstraints(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLServerIntegrationQueryMultipleBelongsTo(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

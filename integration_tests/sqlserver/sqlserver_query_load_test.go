...
func TestSQLServerIntegrationQueryLoadSingleRelationship(t *testing.T) {
	if testing.Short() {
...
func TestSQLServerIntegrationQueryLoadWithConstraints(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLServerIntegrationQueryLoadMissing(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

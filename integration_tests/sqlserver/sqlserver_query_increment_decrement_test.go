...
func TestSQLServerIntegrationQueryIncrement(t *testing.T) {
	if testing.Short() {
...
func TestSQLServerIntegrationQueryDecrement(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLServerIntegrationQueryIncrementDecrementWithWhere(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

...
// seedAggregateTestData inserts four users into the database with two distinct
// avatar groups ("group1" and "group2") for use in aggregate query tests.
// It returns the created users with their database-assigned IDs.

...
func TestSQLServerIntegrationQuerySelectSpecificColumns(t *testing.T) {
	if testing.Short() {
...
func TestSQLServerIntegrationQuerySelectWithAliases(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLServerIntegrationQuerySelectWithRawSubqueries(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

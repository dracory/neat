...
// TestSQLServerSchemaColumnChange tests column change operations
func TestSQLServerSchemaColumnChange(t *testing.T) {
	if testing.Short() {
...
// TestSQLServerSchemaColumnChangeType tests changing column types
func TestSQLServerSchemaColumnChangeType(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestSQLServerSchemaColumnChangeNullable tests changing nullable status
func TestSQLServerSchemaColumnChangeNullable(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

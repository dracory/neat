...
func TestSQLiteIntegrationDistinctSingleColumn(t *testing.T) {
	if testing.Short() {
...
func TestSQLiteIntegrationDistinctMultipleColumns(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLiteIntegrationDistinctWithCount(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLiteIntegrationDistinctWithoutArgsWithCount(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLiteIntegrationDistinctWithSelect(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

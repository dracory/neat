...
func TestSQLiteSchemaColumnMethodsHasColumn(t *testing.T) {
	if testing.Short() {
...
func TestSQLiteSchemaColumnMethodsHasColumns(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLiteSchemaColumnMethodsDropColumn(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLiteSchemaColumnMethodsDropColumns(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLiteSchemaColumnMethodsHasColumnsAfterDrops(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLiteSchemaColumnMethodsSingle(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLiteSchemaColumnMethodsEmpty(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

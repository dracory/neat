...
// TestSQLiteSchemaColumnMethods tests column method operations
func TestSQLiteSchemaColumnMethods(t *testing.T) {
	if testing.Short() {
...
// TestSQLiteSchemaColumnMethodsSingle tests column methods with single column operations
...
// TestSQLiteSchemaColumnMethodsEmpty tests edge cases with empty column lists

...
func TestSQLiteSchemaForeignKeyCreate(t *testing.T) {
	if testing.Short() {
...
func TestSQLiteSchemaForeignKeyCascadeOptions(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLiteSchemaForeignKeyCustomName(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestSQLiteSchemaForeignKeyDropUnsupported(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

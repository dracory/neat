...
// TestQueryDeleteByModel tests deleting records using a model
func TestQueryDeleteByModel(t *testing.T, db *database.Database) {
	query := db.Query()
...
// TestQueryDeleteByTable tests deleting records using a table name
func TestQueryDeleteByTable(t *testing.T, db *database.Database) {
	query := db.Query()
...
// TestQueryDeleteByModelWithWhere tests deleting records with WHERE conditions
func TestQueryDeleteByModelWithWhere(t *testing.T, db *database.Database) {
	query := db.Query()

...
// SeedJoinTestData creates test data for join tests
...
// TestJoinInner tests inner join functionality
func TestJoinInner(t *testing.T, db *database.Database) {
...
// TestJoinInnerWithConditions tests inner join with WHERE conditions
func TestJoinInnerWithConditions(t *testing.T, db *database.Database) {
...
// TestJoinInnerWithAliases tests inner join with table aliases
func TestJoinInnerWithAliases(t *testing.T, db *database.Database) {
	SeedJoinTestData(t, db)
...
// TestJoinLeft tests left join functionality
func TestJoinLeft(t *testing.T, db *database.Database) {
	SeedJoinTestData(t, db)
...
// TestJoinLeftWithConditions tests left join with WHERE conditions
func TestJoinLeftWithConditions(t *testing.T, db *database.Database) {
	SeedJoinTestData(t, db)
...
// TestJoinLeftWithAliases tests left join with table aliases
func TestJoinLeftWithAliases(t *testing.T, db *database.Database) {
	SeedJoinTestData(t, db)
...
// TestJoinRight tests right join functionality
func TestJoinRight(t *testing.T, db *database.Database) {
	SeedJoinTestData(t, db)
...
// TestJoinRightWithConditions tests right join with WHERE conditions
func TestJoinRightWithConditions(t *testing.T, db *database.Database) {
	SeedJoinTestData(t, db)
...
// TestJoinRightWithAliases tests right join with table aliases
func TestJoinRightWithAliases(t *testing.T, db *database.Database) {
	SeedJoinTestData(t, db)
...
// TestJoinCross tests cross join functionality
func TestJoinCross(t *testing.T, db *database.Database) {
	SeedJoinTestData(t, db)
...
// TestJoinCrossWithConditions tests cross join with WHERE conditions
func TestJoinCrossWithConditions(t *testing.T, db *database.Database) {
	SeedJoinTestData(t, db)
...
// TestJoinCrossWithSelect tests cross join with SELECT
func TestJoinCrossWithSelect(t *testing.T, db *database.Database) {
	SeedJoinTestData(t, db)

...
// TestPluckSingleColumn tests plucking a single column
func TestPluckSingleColumn(t *testing.T, db *database.Database) {
...
// TestPluckWithDistinct tests plucking with distinct values
func TestPluckWithDistinct(t *testing.T, db *database.Database) {
	SeedPluckTestData(t, db)

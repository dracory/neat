...
// SeedDistinctTestData creates test data for distinct tests
...
// TestDistinctSingleColumn tests distinct on a single column
func TestDistinctSingleColumn(t *testing.T, db *database.Database) {
...
// TestDistinctWithCount tests distinct with count
func TestDistinctWithCount(t *testing.T, db *database.Database) {
	SeedDistinctTestData(t, db)

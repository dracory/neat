...
// TestFindById tests finding a record by ID
func TestFindById(t *testing.T, db *database.Database) {
	query := db.Query()
...
// TestFindWithWhere tests finding a record with WHERE clause
func TestFindWithWhere(t *testing.T, db *database.Database) {
	query := db.Query()
...
// TestFindWithConditions tests finding records with conditions
func TestFindWithConditions(t *testing.T, db *database.Database) {
	query := db.Query()

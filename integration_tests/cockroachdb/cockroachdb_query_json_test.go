...
func seedCockroachDBJsonTestData(t *testing.T, db *database.Database) []models.JsonData {
	query := db.Query()
...
func TestCockroachDBIntegrationQueryJsonWhereJsonContains(t *testing.T) {
	if testing.Short() {
	...
	query := db.Query()
	seedCockroachDBJsonTestData(t, db)
...
func TestCockroachDBIntegrationQueryJsonWhereJsonContainsArray(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationQueryJsonOrWhereJsonContains(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationQueryJsonWhereJsonDoesntContain(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationQueryJsonWhereJsonContainsKey(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationQueryJsonWhereJsonDoesntContainKey(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationQueryJsonWhereJsonLength(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationQueryJsonWhereJsonLengthInvalidOperator(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationQueryJsonInvalidPathSegment(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationQueryJsonArrayIndexing(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

...
func TestCockroachDBIntegrationQuerySelectSpecificColumns(t *testing.T) {
	if testing.Short() {
...
func TestCockroachDBIntegrationQuerySelectWithAliases(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationQuerySelectWithRawSubqueries(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

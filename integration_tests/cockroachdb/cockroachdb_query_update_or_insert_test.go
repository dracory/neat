...
func TestCockroachDBIntegrationUpdateOrInsertWithMapInsert(t *testing.T) {
	if testing.Short() {
...
func TestCockroachDBIntegrationUpdateOrInsertWithMapUpdate(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationUpdateOrInsertWithStructInsert(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationUpdateOrInsertWithStructUpdate(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationUpdateOrInsertWithWhereClause(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

...
func TestCockroachDBIntegrationWhereAnyAdvanced(t *testing.T) {
	if testing.Short() {
...
func TestCockroachDBIntegrationWhereAllAdvanced(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationWhereNone(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationWhereNoneAdvanced(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
func TestCockroachDBIntegrationWhereEdgeCases(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

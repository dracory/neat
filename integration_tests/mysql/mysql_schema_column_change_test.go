...
// TestMySQLSchemaColumnChange tests column change operations
func TestMySQLSchemaColumnChange(t *testing.T) {
	if testing.Short() {
...
// TestMySQLSchemaColumnChangeType tests changing column types
func TestMySQLSchemaColumnChangeType(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestMySQLSchemaColumnChangeNullable tests changing nullable status
func TestMySQLSchemaColumnChangeNullable(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

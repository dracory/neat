...
// TestMySQLSchemaColumnMethods tests column method operations
func TestMySQLSchemaColumnMethods(t *testing.T) {
	if testing.Short() {
...
// TestMySQLSchemaColumnMethodsSingle tests column methods with single column operations
func TestMySQLSchemaColumnMethodsSingle(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestMySQLSchemaColumnMethodsEmpty tests edge cases with empty column lists
func TestMySQLSchemaColumnMethodsEmpty(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

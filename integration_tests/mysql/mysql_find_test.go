...
func TestMySQLIntegrationFirst(t *testing.T) {
	if testing.Short() {
...
// TestMySQLIntegrationFind tests Find operation
func TestMySQLIntegrationFind(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestMySQLIntegrationCreate tests Create operation
func TestMySQLIntegrationCreate(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestMySQLIntegrationUpdate tests Update operation
func TestMySQLIntegrationUpdate(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}
...
// TestMySQLIntegrationDelete tests Delete operation
func TestMySQLIntegrationDelete(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping integration test in short mode")
	}

...
type Grammar interface {
	...
	CompileDrop(blueprint Blueprint) (string, error)
	// CompileDropAllDomains Compile the SQL needed to drop all domains.
	CompileDropAllDomains(domains []string) (string, error)
	...
	CompileDropIfExists(blueprint Blueprint) (string, error)
	...
	CompileRenameIndex(schema Schema, blueprint Blueprint, command *Command) ([]string, error)
